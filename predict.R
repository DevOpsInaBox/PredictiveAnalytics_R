...
plot(output_dataset$NumDaysActive,output_dataset$Num_Sev_High,main="Number of High severity defects  Vs.  Number of datys Active",xlab='Number of days Active',ylab='Number of High Sev defects')
...
plot(output_dataset$NumDaysActive,output_dataset$Num_Sev_Med,main="Number of Medium severity defects  Vs.  Number of datys Active",xlab='Number of days Active',ylab='Number of Medium Sev defects')
...
plot(output_dataset$NumDaysActive,output_dataset$Num_Sev_Low,main="Number of Low severity defects  Vs.  Number of datys Active",xlab='Number of days Active',ylab='Number of Low Sev defects')
...
plot(output_dataset$NumDaysActive,output_dataset$Num_Priot_High,main="Number of High priority defects  Vs.  Number of datys Active",xlab='Number of days Active',ylab='Number of High Prior defects')
...
plot(output_dataset$NumDaysActive,output_dataset$Num_Priot_Med,main="Number of Medium priority defects  Vs.  Number of datys Active",xlab='Number of days Active',ylab='Number of Medium Prior defects')
...
plot(output_dataset$NumDaysActive,output_dataset$Num_Priot_Low,main="Number of Low priority defects  Vs.  Number of datys Active",xlab='Number of days Active',ylab='Number of Low Prior defects')
