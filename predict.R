...
for(i in 1:30)
{
  ...
  plot(release$numActive,release$Total.num.days,main="Total Num of Days  Vs.  Number of times Active"+paste0("\n Release",i))
  plot(release$numDaysActive,release$Total.num.days,main="Total Num of Days  Vs.  Number of days Active"+paste0("\n Release",i))
  plot(release$numReopened,release$Total.num.days,main="Total Num of Days  Vs.  Number of times Reopened"+paste0("\n Release",i))
  plot(release$LOC,release$Total.num.days,main="Total Num of Days  Vs. Lines of Code"+paste0("\n Release",i))
  input = readline(paste('Press Enter to view "Dev Hours" Plot for release',i))
  plot(release$numActive,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Number of times Active"+paste0("\n Release",i))
  plot(release$numDaysActive,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Number of days Active"+paste0("\n Release",i))
  plot(release$numReopened,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Number of times Reopened"+paste0("\n Release",i))
  plot(release$LOC,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Lines of Code"+paste0("\n Release",i))
  input = readline(paste('Press Enter to view "Testing Hours" Plot for release',i))
  plot(release$numActive,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Number of times Active"+paste0("\n Release",i))
  plot(release$numDaysActive,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Number of days Active"+paste0("\n Release",i))
  plot(release$numReopened,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Number of times Reopened"+paste0("\n Release",i))
  plot(release$LOC,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Lines of Code"+paste0("\n Release",i))
}
