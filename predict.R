...
for(i in 1:30)
{
  ...
  mtext(paste("Plot for 'Defect Age' in release",i), side = 3, line = -21, outer=TRUE)
  ...
  mtext(paste("Plot for 'Dev Hours' in release",i), side = 3, line = -21, outer=TRUE)
  ...
  mtext(paste("Plot for 'Test Hours' in release",i), side = 3, line = -21, outer=TRUE)
}
