...
for(i in 1:30)
{
  ...
  input = readline('Press Enter to view "Number of Times Active" Plot for release'+i)
  plot(release$numActive,release$Total.num.days,main="Total Num of Days  Vs.  Number of times Active")
  plot(release$numDaysActive,release$Total.num.days,main="Total Num of Days  Vs.  Number of days Active")
  plot(release$numReopened,release$Total.num.days,main="Total Num of Days  Vs.  Number of times Reopened")
  plot(release$LOC,release$Total.num.days,main="Total Num of Days  Vs. Lines of Code")
  input = readline('Press Enter to view "Dev Hours" Plot for release'+i)
  plot(release$numActive,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Number of times Active")
  plot(release$numDaysActive,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Number of days Active")
  plot(release$numReopened,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Number of times Reopened")
  plot(release$LOC,release$Num.eff.dev.hours,main="Eff. Dev Hours  Vs.  Lines of Code")
  input = readline('Press Enter to view "Testing Hours" Plot for release'+i)
  plot(release$numActive,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Number of times Active")
  plot(release$numDaysActive,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Number of days Active")
  plot(release$numReopened,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Number of times Reopened")
  plot(release$LOC,release$Num.eff.testing.hours,main="Eff. Testing Hours  Vs.  Lines of Code")
}
