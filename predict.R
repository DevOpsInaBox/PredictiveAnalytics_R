...
for(i in 1:30)
{
  ...
  mtext(paste("Plot for 'Defect Age' in release",i), side = 3, line = -21.5,col="red", outer=TRUE)
  ...
  mtext(paste("Plot for 'Dev Hours' in release",i), side = 3, line = -21.5,col="red", outer=TRUE)
  ...
  mtext(paste("Plot for 'Test Hours' in release",i), side = 3, line = -21.5,col="red", outer=TRUE)
}
...
mtext(paste("Trend analysis for 'Total Number of Days' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Total Dev Hours' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Total Testing Hours' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Number of High Severity Defects' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Number of Medium Severity Defects' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Number of Low Severity Defects' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Number of High Priority Defects' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Number of Medium Priority Defects' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
...
mtext(paste("Trend analysis for 'Number of Low Priority Defects' among all the releases",i), side = 3, line = -21.5,col="red", outer=TRUE)
